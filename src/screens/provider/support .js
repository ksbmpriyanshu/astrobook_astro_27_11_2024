        ...
        function adminforget() {
            return(
              <View style={{margin:Sizes.fixPadding * 2,backgroundColor:'#F9F9F9',borderRadius:10,justifyContent:'center',alignItems:'center',paddingVertical:Sizes.fixPadding}}>
                <Text style={{...Fonts.black18RobotoMedium,color:'#FFA110',marginBottom:Sizes.fixPadding * 0.4,marginTop:Sizes.fixPadding}}>Please Contact</Text>
                ...
                onPress={handlePress}
                activeOpacity={0.6}>
                <Text style={{...Fonts.black16RobotoMedium,color:'#FFA110'}}>support@astroremedy.com</Text>
                </TouchableOpacity>
